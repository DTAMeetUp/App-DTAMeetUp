...
public class EventListDAO {
    ...
    public Event read(int id) {
        ...
        String[] allColumns = new String[]{COL_ID, COL_NAME, COL_LOCATION, COL_TYPE, COL_DESCRIPTION, COL_IMAGEURL, COL_AUTHORID};
        String clause = COL_ID + " = ?";
        String[] clauseArgs = new String[]{String.valueOf(id)};
        ...
        readEvent.setEventAuthorId(cursor.getInt(6));
        cursor.close();
        return readEvent;
    }
    ...
    public ArrayList<Event> readAll() {
        ...
        while (!cursor.isAfterLast()) {
            events.add(new Event(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4),
